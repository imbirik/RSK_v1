...
int main() {
	ofstream trace_out("C:/Users/zaryd/source/repos/RSK_v1/traces.txt");
	ofstream elem_trace_out("C:/Users/zaryd/source/repos/RSK_v1/elem_traces.txt");
	freopen("C:/Users/zaryd/source/repos/RSK_v1/tabluax.txt", "w", stdout);
